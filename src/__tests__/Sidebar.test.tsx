...
describe("Sidebar", () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(useSidebarActions).mockReturnValue(createSidebarActionsState());
  });
  ...
  it("refreshes sidebar documents for selected location", () => {
    ...
    vi.mocked(useSidebarActions).mockReturnValue(createSidebarActionsState({ handleRefreshSidebar }));
  ...
  it("moves a folder into another folder in the same location on drop", () => {
    ...
    vi.mocked(useSidebarActions).mockReturnValue(createSidebarActionsState({ handleMoveDirectory }));
    vi.mocked(useSidebarState).mockReturnValue(
      createSidebarState({
