...
export const oxocarbonLightTheme = EditorView.theme({
  "&": {
  ...
  ".cm-selectionBackground": { backgroundColor: "rgba(15, 98, 254, 0.15)" },
  ".cm-activeLine": { backgroundColor: "rgba(190, 198, 207, 0.45)" },
  ...
  ".cm-searchMatch": { backgroundColor: "rgba(255, 111, 0, 0.35)", outline: `1px solid ${colors.yellow}` },
  ".cm-searchMatch.cm-searchMatch-selected": { backgroundColor: "rgba(255, 111, 0, 0.55)" },
  ...
  ".cm-placeholder": { color: colors.textDisabled },
  ".cm-highlight": { backgroundColor: "rgba(255, 111, 0, 0.35)" },
...
export const oxocarbonLightHighlight = HighlightStyle.define([
...
export const oxocarbonLight = [oxocarbonLightTheme, syntaxHighlighting(oxocarbonLightHighlight)];
