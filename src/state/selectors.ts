...
export const useEditorPresentationStateRaw = () =>
  useLayoutStore(
    useShallow((state) => ({
      ...
      renderedFontFamily: state.renderedFontFamily,
...
export const useEditorPresentationActions = () =>
  useLayoutStore(
    useShallow((state) => ({
      ...
      setRenderedFontFamily: state.setRenderedFontFamily,
...
export const useWorkspaceDocumentsState = () =>
  useWorkspaceStore(
    useShallow((state) => ({
      ...
      documentsByLocation: state.documentsByLocation,
      directoriesByLocation: state.directoriesByLocation,
      expandedLocationIds: state.expandedLocationIds,
      expandedDirectoriesByLocation: state.expandedDirectoriesByLocation,
...
export const useWorkspaceDocumentsActions = () =>
  useWorkspaceStore(
    useShallow((state) => ({
      ...
      setDocumentsForLocation: state.setDocumentsForLocation,
      setDirectoriesForLocation: state.setDirectoriesForLocation,
      setSidebarTreeState: state.setSidebarTreeState,
      toggleExpandedLocation: state.toggleExpandedLocation,
      toggleExpandedDirectory: state.toggleExpandedDirectory,
      expandDirectories: state.expandDirectories,
...
export const useSidebarState = () => {
  ...
  return {
    ...
    documentsByLocation: workspaceState.documentsByLocation,
    directoriesByLocation: workspaceState.directoriesByLocation,
    expandedLocationIds: workspaceState.expandedLocationIds,
    expandedDirectoriesByLocation: workspaceState.expandedDirectoriesByLocation,
    ...
    setDocumentsForLocation: workspaceState.setDocumentsForLocation,
    setDirectoriesForLocation: workspaceState.setDirectoriesForLocation,
    setSidebarTreeState: workspaceState.setSidebarTreeState,
    toggleExpandedLocation: workspaceState.toggleExpandedLocation,
    toggleExpandedDirectory: workspaceState.toggleExpandedDirectory,
    expandDirectories: workspaceState.expandDirectories,
    collapseDirectories: workspaceState.collapseDirectories,
