import { NO_MOTION_TRANSITION, TOOLTIP } from "$constants";
...
export function Tooltip(
  ...
  const transition = useMemo(() => skipAnimation ? NO_MOTION_TRANSITION : TOOLTIP.TRANSITION, [skipAnimation]);
