  ...
  const Inner = useCallback(
    () => (
      <Button
        ...
        className="w-full px-3 py-2 flex items-center gap-2 bg-transparent border-none text-support-error text-[0.8125rem] cursor-pointer text-left rounded hover:bg-support-error hover:text-white">
        <TrashIcon size="sm" />
        Remove
      </Button>
    ),
