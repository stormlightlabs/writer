...
export const ExportDialogHeader = ({ title, onCancel }: ExportDialogHeaderProps) => (
  <div className="mb-4 flex items-start justify-between gap-3 border-b border-stroke-subtle pb-4">
    <div className="min-w-0">
      ...
      {title
        ? (
          <p className="m-0 mt-2 inline-flex items-center gap-1.5 rounded-md border border-stroke-subtle bg-layer-02/55 px-2 py-1 text-xs text-text-secondary">
