...
export const oxocarbonLightTheme = EditorView.theme({
  ...
  ".cm-activeLine": { backgroundColor: "rgba(224, 224, 224, 0.4)" },
  ...
  ".cm-searchMatch": { backgroundColor: "rgba(255, 193, 27, 0.4)", outline: `1px solid ${colors.yellow}` },
  ".cm-searchMatch.cm-searchMatch-selected": { backgroundColor: "rgba(255, 193, 27, 0.6)" },
  ...
  ".cm-highlight": { backgroundColor: "rgba(255, 193, 27, 0.4)" },
