...
export const oxocarbonDarkTheme = EditorView.theme({
  ...
  "&.cm-focused .cm-selectionBackground": { backgroundColor: "rgba(120, 169, 255, 0.3)" },
  ".cm-selectionBackground": { backgroundColor: "rgba(120, 169, 255, 0.2)" },
  ...
  ".cm-searchMatch": { backgroundColor: "rgba(255, 193, 27, 0.3)", outline: `1px solid ${colors.yellow}` },
  ".cm-searchMatch.cm-searchMatch-selected": { backgroundColor: "rgba(255, 193, 27, 0.5)" },
  ...
  ".cm-highlight": { backgroundColor: "rgba(255, 193, 27, 0.3)" },
